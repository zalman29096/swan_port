...
samolety.add(new samolet("samolet0", "sambik0", "messer.gif", "messer_right.gif", 113, 26, 5, 10, 5, false,0));
samolety.add(new samolet("samolet1", "sambik1", "kukuruznik.gif", "kukuruznik(right).gif", 120, 45, 3, 5, 0, false,1));
samolety.add(new samolet("samolet2", "sambik2", "reactiv.gif", "reactiv(right).gif", 174, 35, 6, 15, 0, false,2));
samolety.add(new samolet("samolet3", "sambik3", "messer.gif", "messer_right.gif", 113, 26, 4, 10, 5, false,3));
samolety.add(new samolet("samolet5", "sambik5", "reactiv.gif", "reactiv(right).gif", 174, 35, 7, 15, 0, false,4));
samolety.add(new samolet("samolet6", "sambik6", "passPlane1.gif", "passPlane(right).gif", 174, 35, 4, -100, 0, false,5));
...
oblaka.add(new samolet("cloud0", "fly0", "oblako1.gif", "oblako1.gif", 200, 118, 0.3+0.1*j, 0, 0, true));
oblaka.add(new samolet("cloud1", "fly1", "oblako2.gif", "oblako2.gif", 200, 118, 0.3+0.1*j, 0, 0, true));
oblaka.add(new samolet("cloud2", "fly2", "oblako1.gif", "oblako1.gif", 200, 118, 0.3+0.1*j, 0, 0, true));
oblaka.add(new samolet("cloud3", "fly3", "oblako2.gif", "oblako2.gif", 170, 53, 0.3+0.1*j, 0, 0, true));
