...
function pushka(x,y){
	...
	this.rightStvolPos=new Array(
		new stvolPos(61, 7, 9, -11, "pushka1p.gif"),
		new stvolPos(52, 1, 5.5, -11, "pushka2p.gif"),
		new stvolPos(42, -5, 2.2, -11, "pushka3p.gif")
	);
	this.leftStvolPos=new Array(
		new stvolPos(24, 7, -9, -11, "pushka1l.gif"),
		new stvolPos(34, 1, -5.5, -11, "pushka2l.gif"),
		new stvolPos(45, -5, -2.2, -11, "pushka3l.gif") 
	);
